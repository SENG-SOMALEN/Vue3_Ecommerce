    ...
    <section class="bg-white py-24 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div v-if="isloading" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <div v-for="i in 5" :key="i" class="h-[320px] rounded-[32px] bg-gray-200 animate-pulse">
                </div>
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <router-link 
                    v-for="(cate, index) in categoies" :key="cate.id"
                    :to="{name: 'Shop', query: {category: cate.id}}"
                    class="group relative overflow-hidden rounded-[32px] cursor-pointer block"
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-8">
                        ...
                        <p class="uppercase tracking-[0.25em] text-xs text-white/70 mb-2">
                            Collection
                        </p>
