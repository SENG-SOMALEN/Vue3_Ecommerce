<template>
  <header
    class="sticky top-0 z-50 border-b border-white/10 bg-black/80 backdrop-blur-2xl"
  >
      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-10 ">
          ...
          >
            ...
            <span
              class="ml-3 text-xl font-semibold tracking-tight text-white"
            >
              E-Com
            </span>
          </router-link>
        ...
        <div class="flex items-center gap-5">
          ...
          >
            <svg width="20" height="20" viewBox="0 0 18 18" fill="none">
              <path
                d="M9 15S2 10.5 2 6a4 4 0 017-2.65A4 4 0 0116 6c0 4.5-7 9-7 9z"
                stroke="currentColor"
                stroke-width="1.5"
          ...
          >
            <svg width="20" height="20" viewBox="0 0 18 18" fill="none">
              <path
                d="M1 1h2.5l1.8 9h8.4l1.8-5H4.5"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
    ...
    <transition name="mobile-menu">
      ...
      >
        <ul
          class="flex flex-col px-6 py-6 space-y-5 text-gray-300 font-medium"
        >
          <li>
            <router-link
              to="/"
